...
<body>
    ...
    <?php endif; ?>
    <?php $tot_data = (int)$data['masuk'] - (int)$data['keluar']; ?>
    <?php if ($jenis == "All"): ?>
    ...
    <?php endif; ?>
    <?php if ($jenis == "Harian"): ?>
        <h4>B. DETAIL [<?= angka($data['masuk']) . " - " . angka($data['keluar']); ?>= <?= angka($tot_data); ?>]</h4>
        <table style="width: 100%;">
            <tr>
                <th>Tgl</th>
                <th>Divisi</th>
    ...
    <?php if ($jenis == "Tahunan"): ?>
        ...
        <table style="width: 100%;">
            ...
            <?php foreach ($data['data'] as $k => $i): ?>
                ...
                <tr>
                    <td rowspan="<?= $rowspan; ?>" style="text-align:center;"><?= ($k + 1); ?></td>
                    <td rowspan="<?= $rowspan; ?>" style="text-align:center;"><?= $i['tahun']; ?></td>
                </tr>
                <?php foreach ($i['data'] as $key => $d): ?>
                    <tr>
                        <td><?= $d['divisi']; ?></td>
