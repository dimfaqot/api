...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        if (getenv('ONLINE') == 1) {
            ...
            $this->batea['database'] = getenv('db_name_batea');
            $this->batea['username'] = getenv('db_username_batea');
            $this->batea['password'] = getenv('db_pass_batea');

            $this->grosir['database'] = getenv('db_name_grosir');
            $this->grosir['username'] = getenv('db_username_grosir');
            $this->grosir['password'] = getenv('db_pass_grosir');

            $this->nineclean['database'] = getenv('db_name_nineclean');
            $this->nineclean['username'] = getenv('db_username_nineclean');
            $this->nineclean['password'] = getenv('db_pass_nineclean');
